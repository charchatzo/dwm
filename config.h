...
static const char *fonts[]          = { "Source Code Pro:style=Semibold:size=12" };
...
static Key keys[] = {
	...
	{ControlMask,					XK_F1,	   spawn,		   SHCMD("setxkbmap -layout us")},
	{ControlMask,					XK_F2,	   spawn,		   SHCMD("setxkbmap -layout gr")},
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,       	               1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
